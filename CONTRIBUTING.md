# Contributing to Demo Cat

Demo Cat welcomes new contributors. This document will guide you
through the process.
...
* **Demo Cat Environment** - was the issue discovered on production server or another environment
...
Fork the project [on GitHub](https://github.com/marklogic/demo-cat/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/demo-cat.git
$ cd roxy
$ git remote add upstream git://github.com/marklogic/demo-cat.git
```
...
Go to https://github.com/username/demo-cat and select your feature branch. Click
...
[issue tracker]: https://github.com/marklogic/demo-cat/issues
